...
export const Features = () => {
    ...
    const handleDirClick = e => {
        ...
        setState(prev => {
            ...
            setFeatures(prev => ({ ...prev, iconList: state }));
            return state;
        });
    };
    const handleDividerClick = e => {
        ...
        setState(iconList);
        setFeatures(prev => ({ ...prev, iconList }));
    };
                ...
                >
                    <tbody>
                        <tr>
                            ...
                            >
                                <img
                                    src="https://eroi-s3.s3-us-west-2.amazonaws.com/hp/email-design-system/icons-enclosed/IconContainer.png"
                                    alt=""
                                    width="48"
                                    height="48"
                                    style="display: block"
