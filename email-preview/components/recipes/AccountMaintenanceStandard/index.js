...
const AccountMaintenanceStandard = ({ dir = "ltr", colors = [] }) => {
    return (
        <ModuleContainer>
            {parse(
                template({
...
export default AccountMaintenanceStandard;
...
export const Features = () => {
    ...
    const handleDirClick = e => {
        ...
        const accountmaintenancestandard = {
            dir: checked ? "rtl" : "ltr",
        };
        setState(prev => {
            const state = {
                ...prev,
                ...accountmaintenancestandard,
            };
            setFeatures(prev => ({
                ...prev,
                accountmaintenancestandard: state,
            }));
            return state;
        });
    };
...
export const template = ({ dir = "ltr", colors = [] }) => {
    ...
    return [
        ...
        responsiveImageTemplate({ hasDivider: true, props }),
