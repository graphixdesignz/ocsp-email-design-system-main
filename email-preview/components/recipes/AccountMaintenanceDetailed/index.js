...
import { template as bulletListTemplate } from "../../email/BulletList";
...
const AccountMaintenanceDetailed = ({ dir = "ltr", colors = [] }) => {
    return (
        <ModuleContainer>
            {parse(
                template({
...
export default AccountMaintenanceDetailed;
...
export const Features = () => {
    ...
    const handleDirClick = e => {
        ...
        const accountmaintenancedetailed = {
            dir: checked ? "rtl" : "ltr",
        };
        setState(prev => {
            const state = {
                ...prev,
                ...accountmaintenancedetailed,
            };
            setFeatures(prev => ({
                ...prev,
                accountmaintenancedetailed: state,
            }));
            return state;
        });
    };
...
export const template = ({ dir = "ltr", colors = [] }) => {
    ...
    return [
        ...
        plainTextTemplate({ hasDivider: false, hasHeadline: false, dir }),
        responsiveImageTemplate(props),
        bulletListTemplate(props),
