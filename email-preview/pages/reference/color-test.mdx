import ColorTest, { html } from "../../components/email/ColorTest";
...
This template displays all primary Visual ID colors paired with black and white text.

The purpose of this template is for testing colors across email clients in dark mode.

<LinkButton
    href="https://litmus.com/checklist/emails/public/48ee840"
    target="_blank"
...
>
    <head>
        ...
        <!--[if !mso]><!-->
        <link
            href="https://use.typekit.net/wsp0fpl.css"
            rel="stylesheet"
            type="text/css"
        />
        <style type="text/css">
            @import url(https://use.typekit.net/wsp0fpl.css);
        </style>
        <!--<![endif]-->
        <style type="text/css">
